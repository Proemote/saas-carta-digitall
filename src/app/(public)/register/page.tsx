...
export const metadata = {
  title: "Crear Cuenta — Carta Digital",
  description: "Regístrate en Carta Digital",
};
        ...
        <div className="max-w-md w-full mx-auto">
          <div className="mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Únete a Carta Digital y comienza a gestionar tu menú digital hoy
            </p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-600">
            ¿Ya tienes cuenta?{' '}
            <a href="/login" className="text-purple-600 hover:text-purple-700 font-medium transition">
              Iniciar sesión
            </a>
          </div>
        </div>
